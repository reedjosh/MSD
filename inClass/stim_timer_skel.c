...
*        TCCR0 =                           //normal mode, clock disabled
*        TIMSK =                           //disable _all_ TC0 interrupts	
*        TIFR  =                           //manually clear overflow flag
...
*        TCCR0 =
        ...
        do {
    	 while(                               ) {}; //spin till TC0 OVF flag set
*    	 TIFR =                                     //manually clear TC0 OVF flag
...
*      TCCR1A =                   //disable all output compare pins and set WGM1{1,0} to 0

*      TIMSK  =                                     //disable all TCNT1 interrupts in here
*      ETIMSK =                                     //and in here
*      TIFR   =                                     // manually clear the TC1 overflow flag
*      TCNT1  =                                     // initialize TCNT counter to 0
